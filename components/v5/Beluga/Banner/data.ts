export const bannerData = [
  ...
  // },
  {
    type: '功能二',
    title: '文案大师',
    info: '从点子到文案一键生成！丰富的文案生成模板，覆盖跨境出海商家的全场景，涉及商品描述、博客灵感、广告文案等，集成最新GPT AI模型，10倍提升人效，内容转化率更高。',
    infoMobile: '一键生成内容文案，提效率、促转化',
    image: 'https://media.cdn.ishopastro.com/svg/sa-fe-b-background/copyMaster.svg',
    name: 'beluga_copymaster'
  },
  {
    type: '功能三',
    title: '白鲸广告管理',
