export const schemaData = [
  ...
  {
    title: 'B2B 外贸',
    description: '助力中国外贸商家轻松实现私域获客、询盘转化、履约交付和健康经营。',
    info: [
      '定制化B2B模版, 匹配和助力B类的资质和品牌表达',
      '询盘管理，集成询盘一站式服务，促成高效买卖沟通',
      '小额批发，阶梯定价，购买数量越多享受更高优惠',
  ...
  },
  {
    title: '无货源开店',
    description:
      '具备广告投放等能力的营销型卖家, 通过星盘一件代发插件无库存开店, 对接丰富货源包含1688货源, 入驻供应商货源等。',
    info: [
      '官方DS插件, 清晰指导DropShipper用户快速询盘采购',
      '一键上架, 快速翻译和导入1688货源商品, 方便商品和订单的管理',
  ...
  },
  {
    ...
    info: [
      '一次性购买多店铺运营套餐，便捷开通多个店铺',
      '内置模版支持快速建站、并支持站点商品、主题模版等的选择性复制',
  ...
  },
  {
    title: '一件代发供货',
    description:
      '具备供应链及物流整合优势的卖家, 只需一次开通, 即可通过星盘一键代发平台为星盘独立站卖家提供供应链和履约能力。并通过拓峰科技的shopify一件代发能力链接海量shopify店主。(去往ds产品的链接)',
    info: [
      '自主上架商品, 系统自动同步至星盘DS及Shopify。交易自动回传至星盘后台, 并实现与主流ERP的履约对接',
      '打通1688商品池, 实现一键翻译/一键上架/一键下单',
      '实现与Shopify店主的跨境交易支付, 费率具有强大的行业竞争力',
      '实现与星盘店主的境内人民币交易结算，实现资金的快速流转',
