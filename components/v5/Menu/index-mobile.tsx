...
const Menu: React.FC<MenuProps> = (props) => {
  ...
  return (
    <>
      <div
        className="flex md:hidden justify-center sticky top-0 w-screen h-[48px] text-[16px] leading-[20px] text-[#FFF] z-[100]"
        style={{
      ...
      <div
        className="md:hidden flex-col fixed top-0 left-0 w-screen h-screen bg-[#FFF] z-[100]"
