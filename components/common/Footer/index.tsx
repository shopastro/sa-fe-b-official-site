...
const Vision: React.FC<any> = (props) => {
  ...
  const icpInfoComp = (
    <div className={styles['icp-info']}>
      <a className={styles['i-content']} rel="noreferrer" href="http://beian.miit.gov.cn/" target="_blank">
        浙ICP备2021036268号-1
      </a>
    </div>
  )
  ...
  const gaInfoComp = (
    <div className={classNames(styles['icp-info'], styles['police'])}>
      <a
        ...
        <div className={styles['footer-right']}>
          ...
          <div className={classNames(styles['right-cell'])}>
            ...
            <div className={styles[`${close.contact ? 'opened' : 'closeed'}`]}>
              <a className={styles['item']} href="mailto:contact@shopastro.com" target="_blank" rel="noreferrer">
