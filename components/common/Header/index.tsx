    ...
    menuDataComp = (
      <div className={classNames(styles['header-nav'], styles[`${showMenu && 'show-menu'}`])}>
        ...
        <Fragment>
          ...
          <Button className={classNames(styles['nav-btn'], styles['try-now'])}>
            <a href="mailto:shopastro@shopastro-inc.com">{getLocal('tryBtn')}</a>
          </Button>
        </Fragment>
        ...
        {/*  </div>*/}
        {/*)}*/}
        <div className={styles['nav-close']} onClick={() => !isPc && setShowMenu(!showMenu)}></div>
      </div>
    )
  }
  return (
    ...
    >
      <div className={styles['header-box']}>
        ...
        {showMenu && <div className={styles['nav-mask']} onClick={() => setShowMenu(!showMenu)}></div>}
